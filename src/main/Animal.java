...
public class Animal implements IMapElement, Comparable<Animal>{
	...
	public static final int MINIMUM_ENERGY_FOR_PROCREATION = 25;
	public static final int ENERGY_PER_MOVE=10;
	private Location location;
	private Genome genome;
	private int energy;
	public final Integer id;
    private List<IPositionChangeObserver> observers;
    private IWorldMap mainMap;
   
    public Animal(IWorldMap map,Vector2d initialPosition, MapDirection initialOrientation, int initialEnergy) throws Exception
    {
        this.location=new Location(initialPosition, initialOrientation);
    ...
    public Animal(IWorldMap map,Vector2d initialPosition, MapDirection initialOrientation, int initialEnergy, Genome initialGenome) throws Exception
    {
    	this(map, initialPosition, initialOrientation, initialEnergy);
    ...
    public Animal procreate(Animal partner) throws Exception
    {
    	...
    	Animal child = new Animal(this.mainMap,((MapWithJungle)this.mainMap).getFreePositionInNeighbourhood(this.getPosition()), MapDirection.NORTH, energyGivenByMe+energyGivenByPartner);
    	return child;
    }
